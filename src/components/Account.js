...
const Account = (props) => {
    ...
    return (
        <Container align="center">
            <Paper elevation={12} style={{backgroundColor : 'teal',width : '400px', height : '200px', marginTop: "20px"}}>
                    <Typography style={{color: 'turquoise'}} variant="b" component="h2">User Account</Typography>
                    <AccountCircleSharpIcon style={{color: 'white'}}/>
                    <div style={{color: 'white',textAlign :'left', position :'absolute', marginLeft : '100px', marginTop : '10px'}}>
