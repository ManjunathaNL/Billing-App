                ...
                <Grid item xs={6}> 
                   ...
                   {/* <FormControl size="small" style={{width:"210px", marginTop: '20px'}} >
                     ...
                     <Autocomplete
                       ...
                       renderInput={(params) => (
                         <TextField {...params} label="customer" size="small" variant="outlined" fullWidth />
                       )}
                     />
                   ...
                   <Autocomplete
                       ...
                       style={{width:"194px", marginTop: '20px'}}
                       renderInput={(params) => (
                         <TextField {...params} label="product" size="small" variant="outlined" fullWidth />
                       )}
                     />
                   ...
                   <Grid item xs={12} style={{marginTop: '20px'}}> 
                      <Button type="submit" size="small" variant="contained" color="primary"> GeneratBill </Button>
                   </Grid>
                </Grid>
