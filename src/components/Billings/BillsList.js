...
const BillsList = (props) => {
    ...
    return (
        <div>
            <hr />
            <Typography variant="inherit" component="h2" style={{ color : 'teal',marginBottom : '20px'}}>Bills List</Typography>
            {bills.length === 0 ? (
                <div>
                    {/* <TextField  
                ...
                <div>
                     {/* <TextField  
                       ...
                       value = {input}
                /> */}
                    <Grid container spacing={3} style={{overflowY : 'scroll', maxHeight : '400px'}} >
                         {bills.map((bill) => {
                            return (
